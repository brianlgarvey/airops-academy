...
export function StudyGroupsWhy() {
  ...
  return (
    <>
      {/* Pace / Problem */}
      <section className="py-20 md:py-24 bg-stone-100/60 border-y border-stone-200/60">
      ...
      {/* Two rules */}
      <section className="py-20 md:py-28 bg-stone-100/60 border-y border-stone-200/60">
        <div className="mx-auto max-w-5xl px-5 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-12">
            <p className="text-[12px] font-semibold uppercase tracking-wider text-stone-400 mb-4">
              {rules.eyebrow}
