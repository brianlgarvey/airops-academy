...
function FeaturedQuote() {
  ...
  return (
    <div>
      <div className="rounded-2xl border border-stone-200 bg-white p-8 md:p-10 shadow-sm min-h-[240px] md:min-h-[220px] flex flex-col">
        <div
          className={`flex flex-col h-full transition-opacity duration-500 ${visible ? "opacity-100" : "opacity-0"}`}
        >
          <span
            className={`inline-block self-start text-[10px] font-semibold uppercase tracking-wider px-2.5 py-1 rounded-full mb-5 ${
          ...
          <p className="text-lg md:text-xl text-stone-700 leading-relaxed flex-1">
    ...
    <>
      ...
      <section className="relative pt-28 pb-16 md:pt-36 md:pb-20">
        <div className="mx-auto max-w-3xl px-5 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-6 text-lg sm:text-xl text-stone-500 leading-relaxed max-w-2xl mx-auto">
        ...
        <div className="mx-auto max-w-2xl px-5 sm:px-6 lg:px-8 mt-14">
          <FeaturedQuote />
        </div>
      </section>
